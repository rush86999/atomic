...
`;
    ...
    public async analyze(input: SubAgentInput): Promise<RecruitmentRecommendationAgentResponse> {
        ...
        const parsedResponse = safeParseJSON<Partial<RecruitmentRecommendationAgentResponse>>(
            llmResponse.content,
            this.agentName,
