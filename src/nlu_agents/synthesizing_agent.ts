...
- If the Analytical Agent identifies the problem type as 'advanced_research', 'social_media_management', 'content_creation', or 'personalized_shopping', the \`primaryGoal\` should reflect this, and \`suggestedNextAction.actionType\` should likely be 'invoke_skill' with the corresponding skillId (e.g., 'advancedResearch', 'socialMedia', 'contentCreation', 'personalizedShopping').
