...
import {
  ...
  CustomAvailableTimeType,
  EventType,
  MeetingAssistAttendeeType,
  MeetingAssistCalendarType,
...
export const generateRecurringMeetingAssists = (
  ...
  console.log(
    timeWindows,
    ' timeWindows inside generateRecurringMeetingAssists'
  );
  ...
  for (let i = 0; i < timeWindows.length; i++) {
    ...
    const newRecurringMeetingAssist: MeetingAssistType = {
      ...
      enableAttendeePreferences:
        originalMeetingAssist?.enableAttendeePreferences,
  ...
  recurringMeetingAssists?.forEach((a) =>
    console.log(
      a,
      ' recurringMeetingAssist inside generateRecurringMeetingAssists'
    )
  );
...
export const generateDatesForFutureMeetingAssistsUsingRrule = (
  ...
  console.log(
    ruleStartDate,
    ' ruleStartDate inside generateDatesForFutureMeetingAssistsUsingRrule'
  );
  ...
  windowStartDatesForRecurrence?.forEach((e) =>
    console.log(
      e,
      ' windowDateforrecurrence inside generateDatesForFutureMeetingAssistsUsingRrule'
    )
  );
  ...
  console.log(
    ruleEndDate,
    ' ruleEndDate inside generateDatesForFutureMeetingAssistsUsingRrule'
  );
  ...
  windowEndDatesForRecurrence?.forEach((e) =>
    console.log(
      e,
      ' windowEndDateforrecurrence inside generateDatesForFutureMeetingAssistsUsingRrule'
    )
  );
...
export const getUserGivenId = async (userId: string) => {
  try {
    ...
    const res: { data: { User_by_pk: UserType } } = await got
      .post(postgraphileGraphUrl, {
        json: {
          operationName,
          query,
...
export const insertMeetingAssists = async (
  ...
  try {
    ...
    const res: {
      data: {
        insert_Meeting_Assist: {
          affected_rows: number;
          returning: MeetingAssistType[];
        };
      };
    } = await got
      .post(postgraphileGraphUrl, {
    ...
    console.log(
      res?.data?.insert_Meeting_Assist?.affected_rows,
      ' successfully added recurring meeting assists'
    );
...
export const upsertMeetingAssistCalendars = async (
  ...
  try {
    ...
    const res: {
      data: {
        insert_Meeting_Assist_Calendar: {
          affected_rows: number;
          returning: MeetingAssistCalendarType[];
        };
      };
    } = await got
      .post(postgraphileGraphUrl, {
...
export const googleCalendarSync = async (
  ...
  try {
    ...
    const calendarListAsMeetingAssistCalendar =
      calendarListModified as MeetingAssistCalendarType[];
...
export const updateMeetingAssistAttendee = async (
  ...
  try {
    ...
    const res: {
      data: { update_Meeting_Assist_Attendee_by_pk: MeetingAssistAttendeeType };
    } = await got
      .post(postgraphileGraphUrl, {
        headers: {
          'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const generatePreferredTimesForRecurringMeetingAssist = (
  ...
  console.log(
    ...
    ' originalPreferredTimes, recurringMeetingAssist'
  );
...
export const generateAttendeesAndPreferredTimesForRecurringMeetingAssist = (
  ...
  console.log(
    ...
    recurringMeetingAssist,
    originalPreferredTimes,
    ' originalAttendees, recurringMeetingAssist, originalPreferredTimes inside generateAttendeesAndPreferredTimesForRecurringMeetingAssist before'
  );
  ...
  for (const originalAttendee of originalAttendees) {
    ...
    const attendeeIndex = originalPreferredTimes?.findIndex(
      (o) => o?.attendeeId === originalAttendee?.id
    );

    console.log(
      attendeeIndex,
      ' attendeeIndex inside generateAttendeesAndPreferredTimesForRecurringMeetingAssist'
    );
    console.log(
      originalPreferredTimes,
      ' originalPreferredTimes inside generateAttendeesAndPreferredTimesForRecurringMeetingAssist'
    );
    ...
    if (
      ...
      const recurringPreferredTimesForAttendee =
        generatePreferredTimesForRecurringMeetingAssist(
          originalPreferredTimes?.filter(
            (o) => o?.attendeeId === originalAttendee?.id
          ),
          recurringMeetingAssist,
          recurringAttendee
  ...
  console.log(
    recurringAttendees,
    ' recurringAttendees after inside generateAttendeesAndPreferredTimesForRecurringMeetingAssist'
  );
  console.log(
    recurringPreferredTimes,
    ' recurringPreferredTimes after inside generateAttendeesAndPreferredTimesForRecurringMeetingAssist'
  );
...
export const generateAttendeesAndPreferredTimesForRecurringMeetingAssists = (
  ...
  console.log(
    recurringAttendees,
    ' recurringAttendees inside generateAttendeesForRecurringMeetingAssists before'
  );

  for (const recurringMeetingAssist of recurringMeetingAssists) {
    const newRecurringAttendeesAndPreferredTimes =
      generateAttendeesAndPreferredTimesForRecurringMeetingAssist(
        originalAttendees,
        recurringMeetingAssist,
        originalPreferredTimes
      );

    recurringAttendees.push(
      ...newRecurringAttendeesAndPreferredTimes?.recurringAttendees
    );
    if (
      newRecurringAttendeesAndPreferredTimes?.recurringPreferredTimes?.length >
      0
    ) {
      recurringPreferredTimes.push(
        ...newRecurringAttendeesAndPreferredTimes?.recurringPreferredTimes
      );
    }
  }
  ...
  console.log(
    recurringAttendees,
    ' recurringAttendees inside generateAttendeesAndPreferredTimesForRecurringMeetingAssists after'
  );
  console.log(
    recurringPreferredTimes,
    ' recurringPreferredTimes inside generateAttendeesAndPreferredTimesForRecurringMeetingAssists after generation'
  );
...
export const insertMeetingAssistAttendees = async (
  ...
  try {
    console.log(
      attendees,
      ' attendees called inside insertMeetingAssistAttendees'
    );
    ...
    const res: {
      data: {
        insert_Meeting_Assist_Attendee: {
          affected_rows: number;
          returning: MeetingAssistAttendeeType[];
        };
      };
    } = await got
      .post(postgraphileGraphUrl, {
...
export const upsertOneMeetingAssistAttendee = async (
  attendee: MeetingAssistAttendeeType
) => {
  try {
    ...
    const res: {
      data: { insert_Meeting_Assist_Attendee_one: MeetingAssistAttendeeType };
    } = await got
      .post(postgraphileGraphUrl, {
        headers: {
          'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const deleteMeetingAssistAttendee = async (id: string) => {
  try {
    ...
    const res: {
      data: { delete_Meeting_Assist_Attendee_by_pk: MeetingAssistAttendeeType };
    } = await got
      .post(postgraphileGraphUrl, {
        headers: {
          'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const getMeetingAssistAttendeeByEmail = async (
  primaryEmail: string,
  meetingId: string
) => {
  try {
...
export const updateMeetingAssistAttendanceCount = async (
  id: string,
  ...
  try {
    ...
    const res: { data: { update_Meeting_Assist_by_pk: MeetingAssistType } } =
      await got
        .post(postgraphileGraphUrl, {
          headers: {
            'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const getUserContactInfo = async (id: string) => {
  try {
    ...
    const res: { data: { User_Contact_Info_by_pk: UserContactInfoType } } =
      await got
        .post(postgraphileGraphUrl, {
          headers: {
            'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const generateAvailableSlotsforTimeWindow = (
  ...
  const uniqNotAvailableSlotsInUserTimezone = _.uniqWith(
    notAvailableSlotsInUserTimezone,
    (val, other) =>
      dayjs(val.startDate).tz(userTimezone).format('YYYY-MM-DDTHH:mm') ===
        dayjs(other.startDate).tz(userTimezone).format('YYYY-MM-DDTHH:mm') &&
      dayjs(val.endDate).tz(userTimezone).format('YYYY-MM-DDTHH:mm') ===
        dayjs(other.endDate).tz(userTimezone).format('YYYY-MM-DDTHH:mm')
  );
  ...
  for (let i = 0; i <= diffDays; i++) {
    startDatesForEachDayInHostTimezone.push(
  ...
  if (diffDays < 1) {
    ...
    for (let i = 0; i < startDatesForEachDayInHostTimezone.length; i++) {
      const filteredNotAvailableSlotsInUserTimezone =
        uniqNotAvailableSlotsInUserTimezone?.filter(
          (na) =>
            dayjs(na?.startDate).tz(userTimezone).format('YYYY-MM-DD') ===
            dayjs(startDatesForEachDayInHostTimezone?.[i])
              .tz(userTimezone)
              .format('YYYY-MM-DD')
        );
      ...
      if (i === 0) {
        ...
        availableSlots.push(...generatedSlots);
        availableSlotsByDate[
          `${startDatesForEachDayInHostTimezone?.[i]?.slice(0, 10)}`
        ] = generatedSlots;
        continue;
      }
...
export const generateAvailableSlotsForDate = (
  ...
  if (isFirstDay && isLastDay && userEndDateInHostTimezone) {
    ...
    const dayOfWeekIntByUser = getISODay(
      dayjs(userStartDateInHostTimezone).tz(userTimezone).toDate()
    );

    const dayOfMonthByUser = dayjs(userStartDateInHostTimezone)
      .tz(userTimezone)
      .date();
    let startHourByUser = dayjs(userStartDateInHostTimezone)
      .tz(userTimezone)
      .hour();
    ...
    if (dayjs(userStartDateInHostTimezone).tz(userTimezone).minute() !== 0) {
      for (let i = 0; i < flooredValue; i++) {
        ...
        if (
          dayjs(userStartDateInHostTimezone)
            .tz(userTimezone)
            .isBetween(
              dayjs(userStartDateInHostTimezone)
                .tz(userTimezone)
    ...
    const endHourByHost =
      endTimesByHost?.find((i) => i.day === dayOfWeekIntByUser)?.hour ?? 20;
    const endMinuteByHost =
      endTimesByHost?.find((i) => i.day === dayOfWeekIntByUser)?.minutes ?? 0;
    const endHourByUser = dayjs(userEndDateInHostTimezone)
      .tz(hostTimezone)
      .hour(endHourByHost)
      .tz(userTimezone)
      .hour();
    const endMinuteByUser = dayjs(userEndDateInHostTimezone)
      .tz(hostTimezone)
    ...
    const workStartHourByHost =
      startTimes?.find((i) => i.day === dayOfWeekIntByUser)?.hour || 8;
    const workStartMinuteByHost =
      startTimes?.find((i) => i.day === dayOfWeekIntByUser)?.minutes || 0;
    const workStartHourByUser = dayjs(userStartDateInHostTimezone)
      .tz(hostTimezone)
      .hour(workStartHourByHost)
      .tz(userTimezone)
      .hour();
    const workStartMinuteByUser = dayjs(userStartDateInHostTimezone)
      .tz(hostTimezone)
    ...
    if (
      ...
      for (let i = 0; i < totalMinutes; i += slotDuration) {
        ...
        availableSlotsInUserTimezone.push({
          id: uuid(),
          startDate: dayjs(userStartDateInHostTimezone)
            .tz(userTimezone)
            ...
            .second(0)
            .format(),
          endDate: dayjs(userStartDateInHostTimezone)
            .tz(userTimezone)
            .hour(startHourByUser)
            .minute(startMinuteByUser)
      ...
      console.log(
        availableSlotsInUserTimezone,
        ' timeSlots inside generateTimeSlots for first day where startDate is before work start time'
      );

      // filter out unavailable times
      const filteredAvailableSlotsInUserTimezone =
        availableSlotsInUserTimezone.filter((a) => {
          const foundIndex = notAvailableSlotsInUserTimezone?.findIndex(
            (na) => {
              const partA = dayjs(a.endDate)
                .tz(userTimezone)
                .second(0)
                .isBetween(
                  dayjs(na.startDate).tz(userTimezone).add(1, 'm').second(0),
                  dayjs(na.endDate).tz(userTimezone).subtract(1, 'm').second(0),
                  'm',
                  '[]'
                );
      ...
      console.log(
        filteredAvailableSlotsInUserTimezone,
  ...
  if (isFirstDay) {
    ...
    const endMinuteByHost =
      endTimesByHost?.find((i) => i.day === dayOfWeekIntByUser)?.minutes ?? 0;
    const endHourByUser = dayjs(userStartDateInHostTimezone)
      .tz(hostTimezone)
      .hour(endHourByHost)
      .tz(userTimezone)
      .hour();
    const endMinuteByUser = dayjs(userStartDateInHostTimezone)
      .tz(hostTimezone)
      .minute(endMinuteByHost)
      .tz(userTimezone)
      .minute();
          ...
          const foundIndex = notAvailableSlotsInUserTimezone?.findIndex(
            (na) => {
              const partA = dayjs(a.endDate)
                .second(0)
                .isBetween(
                  dayjs(na.startDate).add(1, 'm').second(0),
                  dayjs(na.endDate).subtract(1, 'm').second(0),
                  'm',
                  '[]'
                );
              ...
              const partC =
                dayjs(na.startDate).second(0).format('YYYY-MM-DDTHH:mm') ===
                  dayjs(a.startDate).second(0).format('YYYY-MM-DDTHH:mm') &&
                dayjs(na.endDate).second(0).format('YYYY-MM-DDTHH:mm') ===
                  dayjs(a.endDate).second(0).format('YYYY-MM-DDTHH:mm');
  ...
  const endMinuteByHost =
    endTimesByHost?.find((i) => i.day === dayOfWeekIntByUser)?.minutes ?? 0;
  let endHourByUser = dayjs(userStartDateInHostTimezone)
    .tz(hostTimezone)
    .hour(endHourByHost)
    .minute(endMinuteByHost)
    .tz(userTimezone)
    .hour();
  let endMinuteByUser = dayjs(userStartDateInHostTimezone)
    .tz(hostTimezone)
    .hour(endHourByHost)
    .minute(endMinuteByHost)
    .tz(userTimezone)
  ...
  if (isLastDay && userEndDateInHostTimezone) {
    if (
      dayjs(userEndDateInHostTimezone)
        .tz(userTimezone)
        .isBefore(
          dayjs(userEndDateInHostTimezone)
            .tz(userTimezone)
  ...
  const startHourByHost = startTimesByHost?.find(
    (i) => i.day === dayOfWeekIntByUser
  )?.hour as number;
  const startMinuteByHost = startTimesByHost?.find(
    (i) => i.day === dayOfWeekIntByUser
  )?.minutes as number;
  const startHourByUser = dayjs(userStartDateInHostTimezone)
    .tz(hostTimezone)
    .hour(startHourByHost)
    .minute(startMinuteByHost)
    .tz(userTimezone)
    .hour();
  const startMinuteByUser = dayjs(userStartDateInHostTimezone)
    .tz(hostTimezone)
    .hour(startHourByHost)
    .minute(startMinuteByHost)
    .tz(userTimezone)
...
export const cancelMeetingAssist = async (id: string) => {
  try {
...
export const deleteMeetingAssistPreferredTimesByIds = async (ids: string[]) => {
  try {
    ...
    const res: {
      data: {
        delete_Meeting_Assist_Preferred_Time_Range: {
          affected_rows: number;
...
export const upsertMeetingAssistPreferredTimes = async (
  ...
  try {
    console.log(
      preferredTimes,
      ' preferredTimes inside upsertMeetingAssistPreferredTimes'
    );
...
export const startMeetingAssist = async (
  ...
  try {
    const res = await got.post(meetingAssistAdminUrl, {
      headers: {
...
export const getCustomAvailableTimes = (
  ...
  if (isFirstDay) {
    ...
    let startHourByUser = dayjs(hostStartDate.slice(0, 19))
      .tz(hostTimezone, true)
      .tz(userTimezone)
      .hour();
    ...
    const endMinuteByHost =
      endTimesByHost?.find((i) => i.day === dayOfWeekIntByUser)?.minutes ?? 0;
    const endHourByUser = dayjs(hostStartDate.slice(0, 19))
      .tz(hostTimezone, true)
      .hour(endHourByHost)
      .tz(userTimezone)
      .hour();
    const endMinuteByUser = dayjs(hostStartDate.slice(0, 19))
      .tz(hostTimezone, true)
      .minute(endMinuteByHost)
      .tz(userTimezone)
      .minute();
    ...
    const workStartMinuteByHost =
      startTimes?.find((i) => i.day === dayOfWeekIntByUser)?.minutes || 0;
    const workStartHourByUser = dayjs(hostStartDate.slice(0, 19))
      .tz(hostTimezone, true)
      .hour(workStartHourByHost)
      .tz(userTimezone)
      .hour();
    const workStartMinuteByUser = dayjs(hostStartDate.slice(0, 19))
      .tz(hostTimezone, true)
      .minute(workStartMinuteByHost)
      .tz(userTimezone)
      .minute();
  ...
  const startHourByHost = startTimesByHost?.find(
    (i) => i.day === dayOfWeekIntByHost
  )?.hour as number;
  const startMinuteByHost = startTimesByHost?.find(
    (i) => i.day === dayOfWeekIntByHost
  )?.minutes as number;
  const startHourByUser = dayjs(hostStartDate.slice(0, 19))
    .tz(hostTimezone, true)
    .hour(startHourByHost)
    .minute(startMinuteByHost)
    .tz(userTimezone)
    .hour();
  const startMinuteByUser = dayjs(hostStartDate.slice(0, 19))
    .tz(hostTimezone, true)
    .hour(startHourByHost)
    .minute(startMinuteByHost)
    .tz(userTimezone)
  ...
  // convert to user timezone so everything is linked to user timezone
  const endHourByHost: number =
    endTimesByHost?.find((i) => i.day === dayOfWeekIntByHost)?.hour ?? 20;
  const endMinuteByHost =
    endTimesByHost?.find((i) => i.day === dayOfWeekIntByHost)?.minutes ?? 0;
...
export const getMeetingAssistInviteGivenId = async (id: string) => {
  try {
    ...
    const res: {
      data: { Meeting_Assist_Invite_by_pk: MeetingAssistInviteType };
    } = await got
      .post(postgraphileGraphUrl, {
        headers: {
          'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const listMeetingAssistInvitesGivenMeetingId = async (
  ...
  try {
    ...
    const res: { data: { Meeting_Assist_Invite: MeetingAssistInviteType[] } } =
      await got
        .post(postgraphileGraphUrl, {
          headers: {
            'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const updateMeetingAssistInviteResponse = async (
  ...
  try {
    ...
    const res: {
      data: { update_Meeting_Assist_Invite_by_pk: MeetingAssistInviteType };
    } = await got
      .post(postgraphileGraphUrl, {
        headers: {
          'X-Postgraphile-Admin-Secret': postgraphileAdminSecret,
...
export const createRecurringMeetingAssists = async (
  ...
  try {
    ...
    console.log(
      originalPreferredTimes,
      ' originalPreferredTimes  inside createRecurringMeetingAssists'
    );
    const meetingAssistAttendees =
      await listMeetingAssistAttendeesGivenMeetingId(originalMeetingAssist?.id);

    console.log(
      meetingAssistAttendees,
      ' meetingAssistAttendees inside createRecurringMeetingAssists'
    );
    ...
    const recurringMeetingAssists = generateRecurringMeetingAssists(
    ...
    const recurringMeetingAssistAttendeesAndRecurringPreferredTimes =
      generateAttendeesAndPreferredTimesForRecurringMeetingAssists(
        meetingAssistAttendees,
        recurringMeetingAssists,
        originalPreferredTimes
      );

    console.log(
      recurringMeetingAssistAttendeesAndRecurringPreferredTimes?.recurringAttendees,
      ' recurringMeetingAssistAttendees'
    );
    console.log(
      recurringMeetingAssistAttendeesAndRecurringPreferredTimes?.recurringPreferredTimes,
      ' recurringPreferredTimes'
    );

    await insertMeetingAssistAttendees(
      recurringMeetingAssistAttendeesAndRecurringPreferredTimes.recurringAttendees
    );

    if (
      recurringMeetingAssistAttendeesAndRecurringPreferredTimes
        ?.recurringPreferredTimes?.length > 0
    ) {
      await upsertMeetingAssistPreferredTimes(
        recurringMeetingAssistAttendeesAndRecurringPreferredTimes?.recurringPreferredTimes
      );
    }
  } catch (e) {
