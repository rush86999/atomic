declare enum PERSONMETADATAOBJECT {
...
type phoneType = 'home' | 'work' | 'mobile' | 'homeFax' | 'workFax' | 'otherFax' | 'pager' | 'workMobile' | 'workPager' | 'main' | 'googleVoice' | 'other';
type PhoneNumber = {
    metadata: FieldMetadata;
    value: string;
...
type ImClient = {
    ...
    type: string;
    formattedType: string;
    protocol: 'aim' | 'msn' | 'yahoo' | 'skype' | 'qq' | 'googleTalk' | 'icq' | 'jabber' | 'netMeeting';
