...
const requiredFields: RequiredFieldsType = {
    ...
    dateTime: {
        ...
        optional: [
            ...
            { oneOf: [{ value: 'findTimeWindowStart.day', type: 'chat' }, { value: 'findTimeWindowStart.isoWeekday', type: 'chat' }] },
            { oneOf: [{ and: [{ value: 'findTimeWindowStart.hour', type: 'chat' }, { value: 'findTimeWindowStart.minute', type: 'chat' }] }, { value: 'findTimeWindowStart.startTime', type: 'chat' }] },
            { oneOf: [{ value: 'findTimeWindowEnd.day', type: 'chat' }, { value: 'findTimeWindowEnd.isoWeekday', type: 'chat' }] },
            { oneOf: [{ and: [{ value: 'findTimeWindowEnd.hour', type: 'chat' }, { value: 'findTimeWindowEnd.minute', type: 'chat' }] }, { value: 'findTimeWindowEnd.startTime', type: 'chat' }] }
        ]
