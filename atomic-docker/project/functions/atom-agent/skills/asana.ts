...
export async function handleCreateAsanaTask(
  userId: string,
  entities: any
): Promise<string> {
  try {
    ...
    return handleError(
      error,
      "Sorry, I couldn't create the Asana task due to an error."
    );
  }
}

export async function handleQueryAsanaTasks(
  userId: string,
  entities: any
): Promise<string> {
  try {
    ...
    return handleError(
      error,
      "Sorry, I couldn't query the Asana tasks due to an error."
    );
  }
}

export async function handleUpdateAsanaTask(
  userId: string,
  entities: any
): Promise<string> {
  try {
    ...
    return handleError(
      error,
      "Sorry, I couldn't update the Asana task due to an error."
    );
  }
}
