...
describe('email skill', () => {
  ...
  describe('handleListEmails', () => {
    ...
    it('should return an error message when an error occurs', async () => {
      (emailSkills.listRecentEmails as jest.Mock).mockRejectedValue(
  ...
  describe('handleReadEmail', () => {
    ...
    it('should return an error message when an error occurs', async () => {
      (emailSkills.readEmail as jest.Mock).mockRejectedValue(
        new Error('Test Error')
      );
  ...
  describe('handleSendEmail', () => {
    ...
    it('should return an error message when the recipient is missing', async () => {
      ...
      expect(result).toBe(
        "Recipient 'to' address is required to send an email via NLU."
      );
    });
    ...
    it('should return an error message when an error occurs', async () => {
      ...
      (emailSkills.sendEmail as jest.Mock).mockRejectedValue(
        new Error('Test Error')
      );
