...
describe('calendar skill', () => {
  ...
  describe('handleGetCalendarEvents', () => {
    ...
    it('should return a message when there are no upcoming events', async () => {
      ...
      expect(result).toBe(
        "No upcoming calendar events found matching your criteria, or I couldn't access them."
      );
    });
  ...
  describe('handleCreateCalendarEvent', () => {
    ...
    it('should return an error message when the summary is missing', async () => {
      ...
      expect(result).toBe(
        'Event summary is required to create an event via NLU.'
      );
    });
    ...
    it('should return an error message when the start time is missing', async () => {
      ...
      expect(result).toBe(
        'Event start time is required to create an event via NLU.'
      );
    });
    ...
    it('should return an error message when the end time and duration are missing', async () => {
      ...
      expect(result).toBe(
        'Event end time or duration is required to create an event via NLU.'
      );
    });
    ...
    it('should return an error message when an error occurs', async () => {
      ...
      (calendarSkills.createCalendarEvent as jest.Mock).mockRejectedValue(
        new Error('Test Error')
      );
