...
describe('hubspot skill', () => {
  ...
  describe('handleGetHubSpotContactByEmail', () => {
    it('should return a HubSpot contact', async () => {
      ...
      (hubspotSkills.getHubSpotContactByEmail as jest.Mock).mockResolvedValue(
        mockContact
      );
    ...
    it('should return a message when no contact is found', async () => {
      ...
      expect(result).toBe(
        'No HubSpot contact found with email: test@example.com.'
      );
    });
    ...
    it('should return an error message when the email is missing', async () => {
      ...
      expect(result).toBe(
        'Email is required and must be a non-empty string to get a HubSpot contact by email.'
      );
    });

    it('should return an error message when an error occurs', async () => {
      (hubspotSkills.getHubSpotContactByEmail as jest.Mock).mockRejectedValue(
  ...
  describe('handleCreateHubSpotContact', () => {
    ...
    it('should return an error message when the email is missing', async () => {
      ...
      expect(result).toBe(
        'Email is required (and must be a string) to create a HubSpot contact via NLU.'
      );
    });

    it('should return an error message when an error occurs', async () => {
      (hubspotSkills.createHubSpotContact as jest.Mock).mockRejectedValue(
        new Error('Test Error')
      );
