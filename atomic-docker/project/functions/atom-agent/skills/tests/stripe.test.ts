...
describe('stripe skill', () => {
    ...
    describe('handleListStripePayments', () => {
        it('should return a list of Stripe payments', async () => {
            ...
            (stripeSkills.listStripePayments as jest.Mock).mockResolvedValue(mockResponse);
        ...
        it('should return an error message when an error occurs', async () => {
            (stripeSkills.listStripePayments as jest.Mock).mockRejectedValue(new Error('Test Error'));
    ...
    describe('handleGetStripePaymentDetails', () => {
        it('should return the details of a Stripe payment', async () => {
            ...
            (stripeSkills.getStripePaymentDetails as jest.Mock).mockResolvedValue(mockResponse);

            const result = await handleGetStripePaymentDetails('test-user', { payment_intent_id: 'pi_123' });
        ...
        it('should return an error message when an error occurs', async () => {
            (stripeSkills.getStripePaymentDetails as jest.Mock).mockRejectedValue(new Error('Test Error'));
