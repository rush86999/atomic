...
describe('quickbooks skill', () => {
    ...
    describe('handleGetQuickBooksAuthUrl', () => {
        it('should return the QuickBooks auth URL', async () => {
            (quickbooksSkills.getAuthUri as jest.Mock).mockReturnValue('https://example.com/auth');
    ...
    describe('handleListQuickBooksInvoices', () => {
        it('should return a list of QuickBooks invoices', async () => {
            ...
            (quickbooksSkills.listQuickBooksInvoices as jest.Mock).mockResolvedValue(mockResponse);
        ...
        it('should return an error message when an error occurs', async () => {
            (quickbooksSkills.listQuickBooksInvoices as jest.Mock).mockRejectedValue(new Error('Test Error'));
    ...
    describe('handleGetQuickBooksInvoiceDetails', () => {
        it('should return the details of a QuickBooks invoice', async () => {
            ...
            (quickbooksSkills.getQuickBooksInvoiceDetails as jest.Mock).mockResolvedValue(mockResponse);

            const result = await handleGetQuickBooksInvoiceDetails('test-user', { invoice_id: '123' });
        ...
        it('should return an error message when an error occurs', async () => {
            (quickbooksSkills.getQuickBooksInvoiceDetails as jest.Mock).mockRejectedValue(new Error('Test Error'));
