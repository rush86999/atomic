...
describe('zoom skill', () => {
    ...
    describe('handleListZoomMeetings', () => {
        it('should return a list of Zoom meetings', async () => {
            ...
            (zoomSkills.listZoomMeetings as jest.Mock).mockResolvedValue(mockResponse);
        ...
        it('should return an error message when an error occurs', async () => {
            (zoomSkills.listZoomMeetings as jest.Mock).mockRejectedValue(new Error('Test Error'));
    ...
    describe('handleGetZoomMeetingDetails', () => {
        it('should return the details of a Zoom meeting', async () => {
            ...
            (zoomSkills.getZoomMeetingDetails as jest.Mock).mockResolvedValue(mockResponse);

            const result = await handleGetZoomMeetingDetails('test-user', { meeting_id: '123' });
        ...
        it('should return an error message when an error occurs', async () => {
            (zoomSkills.getZoomMeetingDetails as jest.Mock).mockRejectedValue(new Error('Test Error'));
