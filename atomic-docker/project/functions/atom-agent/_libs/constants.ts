...
export const ATOM_GOOGLE_CALENDAR_REDIRECT_URI =
  process.env.ATOM_GOOGLE_CALENDAR_REDIRECT_URI;

export const GOOGLE_TOKEN_URL = 'https://oauth2.googleapis.com/token';
export const GOOGLE_CALENDAR_API_SCOPE =
...
export const ATOM_SLACK_HUBSPOT_NOTIFICATION_CHANNEL_ID =
  process.env.ATOM_SLACK_HUBSPOT_NOTIFICATION_CHANNEL_ID || '';

// Default Slack Channel ID for "My Agenda" notifications, if user-specific DM is not used/available.
// Can be overridden by environment variable.
export const ATOM_DEFAULT_SLACK_CHANNEL_FOR_AGENDA =
  process.env.ATOM_DEFAULT_SLACK_CHANNEL_FOR_AGENDA || '';
...
export const ATOM_CALENDLY_PERSONAL_ACCESS_TOKEN =
  process.env.ATOM_CALENDLY_PERSONAL_ACCESS_TOKEN || '';
...
export const ATOM_ZOOM_CLIENT_SECRET =
  process.env.ATOM_ZOOM_CLIENT_SECRET || '';
...
export const ATOM_MSGRAPH_CLIENT_SECRET =
  process.env.ATOM_MSGRAPH_CLIENT_SECRET || '';
...
export const ATOM_MSGRAPH_SCOPES = (
  process.env.ATOM_MSGRAPH_SCOPES || 'https://graph.microsoft.com/.default'
).split(',');
...
export const ATOM_QB_TOKEN_FILE_PATH =
  process.env.ATOM_QB_TOKEN_FILE_PATH || './qb_tokens.json';
...
export const ATOM_QB_SCOPES = (
  process.env.ATOM_QB_SCOPES ||
...
export const ATOM_NLU_MODEL_NAME =
  process.env.ATOM_NLU_MODEL_NAME || 'gpt-3.5-turbo-1106';
...
export const NOTION_NOTES_DATABASE_ID =
  process.env.NOTION_NOTES_DATABASE_ID || ''; // General notes
export const NOTION_RESEARCH_PROJECTS_DB_ID =
  process.env.NOTION_RESEARCH_PROJECTS_DB_ID || '';
export const NOTION_RESEARCH_TASKS_DB_ID =
  process.env.NOTION_RESEARCH_TASKS_DB_ID || '';
export const ATOM_NOTION_TASKS_DATABASE_ID =
  process.env.ATOM_NOTION_TASKS_DATABASE_ID || ''; // For task management
...
export const PYTHON_RESEARCH_API_URL =
  process.env.PYTHON_RESEARCH_API_URL || '';
...
export const PYTHON_TRAINING_API_URL =
  process.env.PYTHON_TRAINING_API_URL || '';

// Base URL for the main Python API service (which might consolidate note_handler, task_handler, etc.)
export const PYTHON_API_SERVICE_BASE_URL =
  process.env.PYTHON_API_SERVICE_BASE_URL || 'http://localhost:8080';
