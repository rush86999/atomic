...
export type User = 'id' | 'createdAt' | 'displayName' | 'avatarUrl' | 'locale' | 'email' | 'isAnonymous' | 'defaultRole' | 'metadata' | 'emailVerified' | 'phoneNumber' | 'phoneNumberVerified' | ('activeMfaType' & {
    roles: string[];
});
export type Session = {
    accessToken: string;
...
export declare const EMAIL_TYPES: {
    readonly VERIFY: "emailVerify";
    readonly CONFIRM_CHANGE: "emailConfirmChange";
    readonly SIGNIN_PASSWORDLESS: "signinPasswordless";
