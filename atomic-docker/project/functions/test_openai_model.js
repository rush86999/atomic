...
async function main() {
  ...
  console.log(`Attempting to call OpenAI embeddings API with model: '${modelToTest}' and input: '${testInput}'`);
  ...
  try {
    ...
    console.log("Embedding result (should not happen with placeholder key):", embedding);
  } catch (error) {
