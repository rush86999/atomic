import { EventPartPlannerRequestBodyType, MeetingAssistEventType, WorkTimeType } from '@post_process_calendar/_libs/types';
import { EventPlusType } from '@post_process_calendar/_libs/types';
import { RemindersForEventType, BufferTimeObjectType } from '@post_process_calendar/_libs/types';
...
export type GetOptaPlanBodyForCalendarType = {
  singletonId: string,
  hostId: string,
