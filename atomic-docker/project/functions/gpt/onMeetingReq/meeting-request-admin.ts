...
const kafka = new Kafka({
    clientId: process.env.KAFKA_CLIENT_ID_MEETING_REQ_ADMIN || 'gpt-meeting-req-admin-producer',
...
export const handler = async (req: Request, res: Response) => {
    ...
    try {
        ...
        return res.status(202).json({ message: 'Successfully queued meeting request processing.' });
