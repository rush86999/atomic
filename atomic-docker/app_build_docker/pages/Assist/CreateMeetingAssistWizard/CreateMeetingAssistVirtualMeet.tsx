...
function CreateMeetingAssistVirtualMeet(props: Props) {
  ...
  return (
    <Box flex={1} justifyContent="center" alignItems="center" minHeight="65vh" width="80%">
...
export default CreateMeetingAssistVirtualMeet