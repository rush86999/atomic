...
function Contacts(props: selectedContactsProps) {
    ...
    return (
      <Box flex={1}  minHeight="65vh" maxHeight="65vh">
        <Box>
          <form>   
...
function EditMeetingAssistInvitees(props: Props) {
