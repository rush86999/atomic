...
export type SkillType =
  ...
  | 'delete-priority'
  | 'delete-task'
  | 'edit-add-preferred-time-to-preferred-times'
  | 'edit-event'
  | 'edit-remove-preferred-time-to-preferred-times'
  | 'find-meeting-time-with-permission'
  | 'generate-meeting-invite'
  | 'remove-all-preferred-times'
...
export type UserChatType = {
  ...
  customComponentType?:
    ...
    | 'meeting_prep_results'
    | 'daily_briefing_results'
    | 'image_display'
    | 'chart_display'
    | 'other_custom_component'; // To identify component type
