...
export const hasuraApiUrl = process.env.NEXT_PUBLIC_POSTGRAPHILE_GRAPHQL_URL;

export const eventToQueueAuthUrl =
  process.env.NEXT_PUBLIC_EVENT_TO_QUEUE_AUTH_URL;
export const eventToQueueShortAuthUrl =
  process.env.NEXT_PUBLIC_EVENT_TO_QUEUE_SHORT_AUTH_URL;
export const calendarToQueueAuthUrl =
  process.env.NEXT_PUBLIC_CALENDAR_TO_QUEUE_AUTH_URL;
export const featuresApplyToEventsAuthUrl =
  process.env.NEXT_PUBLIC_FEATURES_APPLY_TO_EVENTS_AUTH_URL;

export const methodToSearchIndexAuthUrl =
  process.env.NEXT_PUBLIC_METHOD_TO_SEARCH_INDEX_AUTH_URL;

export const lanceEventMatcherUrl =
  process.env.NEXT_PUBLIC_LANCE_EVENT_MATCHER_URL || '/api/lance-event-matcher';
...
export const postgraphileWSUrl = process.env
  .NEXT_PUBLIC_POSTGRAPHILE_GRAPHQL_URL
  ? process.env.NEXT_PUBLIC_POSTGRAPHILE_GRAPHQL_URL.replace(/^http/, 'ws')
  : undefined;

export const googleCalendarAndroidAuthUrl =
  process.env.NEXT_PUBLIC_GOOGLE_CALENDAR_ANDROID_AUTH_URL;
export const googleClientIdAtomicWeb = process.env.GOOGLE_CLIENT_ID_ATOMIC_WEB;
export const googleCalendarAndroidAuthRefreshUrl =
  process.env.NEXT_PUBLIC_GOOGLE_CALENDAR_ANDROID_AUTH_REFRESH_URL;
export const googleAtomicWebAuthRefreshUrl =
  process.env.NEXT_PUBLIC_GOOGLE_ATOMIC_WEB_AUTH_REFRESH_URL;
export const googleCalendarIosAuthRefreshUrl =
  process.env.NEXT_PUBLIC_GOOGLE_CALENDAR_IOS_AUTH_REFRESH_URL;
...
export const googleOAuthAtomicWebAPIStartUrl =
  process.env.NEXT_PUBLIC_GOOGLE_OAUTH_ATOMIC_WEB_API_START_URL;
export const googleSignInNormalButton =
  'public/images/google-signin-normal.png';
export const googleSignInDarkButton =
  'public/images/google-signin-dark-normal.png';
export const messyDoodleSVG = '/MessyDoodle.svg';
export const googleOAuthAtomicWebRedirectUrl =
  process.env.NEXT_PUBLIC_GOOGLE_OAUTH_ATOMIC_WEB_REDIRECT_URL;
...
export const PYTHON_TRAINING_API_URL =
  process.env.NEXT_PUBLIC_PYTHON_TRAINING_API_URL;
...
export const SCHEDULER_API_URL =
  process.env.NEXT_PUBLIC_SCHEDULER_API_URL || 'http://localhost:8080';
