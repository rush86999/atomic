    ...
    startButton.addEventListener('click', async () => {
        ...
        try {
            ...
            if (!MediaRecorder.isTypeSupported(options.mimeType)) {
                ...
                if (!MediaRecorder.isTypeSupported(options.mimeType)) {
                    console.warn(`${options.mimeType} is not supported. Trying without specifying.`);
            ...
            mediaRecorder.onstop = () => {
                ...
                if (audioChunks.length === 0) {
                    setStatus("Recording stopped, but no audio data was captured. Please try again.");
            ...
            setStatus(`Error: ${err.message}. Ensure microphone is connected and permission granted.`);
            startButton.disabled = false;
            stopButton.disabled = true;
            playButton.disabled = true;
            downloadButton.disabled = true;
