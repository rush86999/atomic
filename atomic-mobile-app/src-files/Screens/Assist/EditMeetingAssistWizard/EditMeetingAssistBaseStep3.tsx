...
function EditMeetingAssistBaseStep3(props: Props) {
    ...
    return (
        <Box flex={1} justifyContent="center" alignItems="center" style={{ width: '100%' }}>
          <Box flex={1} pt={{ phone: 'l', tablet: 'xl' }} flexDirection="row" justifyContent="flex-start" alignItems="center" style={{ width: '80%'}}>
              <Box  style={{ width: '60%'}}>
                  <TextField
                      title="Host Name"
            ...
            <Box flex={1} mt={{ phone: 's', tablet: 'm' }} justifyContent="center" alignItems="flex-start" style={{ width: '80%' }}>
          ...
          <Box flex={1} m={{ phone: 's', tablet: 'm' }} justifyContent="center" alignItems="center" style={{ width: '80%'}} >
            <Box flexDirection="row" justifyContent="flex-start" alignItems="center" style={{ width: '100%'}}>
              <Hint visible={isMessage} message={'Should it block time on your calendar'} color={Colors.purple} onBackgroundPress={() => setIsMessage(false)}>
                  <Pressable onPress={() => setIsMessage(!isMessage)}> 
          ...
          <Box flex={1} m={{ phone: 's', tablet: 'm' }} justifyContent="center" alignItems="center" style={{ width: '80%' }}>
            <Box flexDirection="row" justifyContent="flex-start" alignItems="center" style={{ width: '100%'}}>
              <Hint visible={isMessage} message={'Who can see the details of the event - anyone or just attendees'} color={Colors.purple} onBackgroundPress={() => setIsMessage(false)}>
                  <Pressable onPress={() => setIsMessage(!isMessage)}> 
                      <Text m={{ phone: 's', tablet: 'm' }} variant="buttonLink">
...
export default EditMeetingAssistBaseStep3
