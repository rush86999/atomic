...
type UserViewWaistStatsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaistStats'
>
...
function UserViewWaistStats(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaistStatsNavigationProp>()
...
export default UserViewWaistStats
