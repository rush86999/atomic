...
type UserViewWaistWeeklyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaistWeekly'
>
...
function UserViewWaistWeekly(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaistWeeklyNavigationProp>()
...
export default UserViewWaistWeekly
