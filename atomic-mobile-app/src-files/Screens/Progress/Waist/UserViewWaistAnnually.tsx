...
type RootStackParamList = {
  ...
  UserViewWaistAnnaly: undefined,
}

type UserViewWaistAnnualyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaistAnnualy'
>
...
function UserViewWaistAnnually(props: Props) {
...
export default UserViewWaistAnnually
