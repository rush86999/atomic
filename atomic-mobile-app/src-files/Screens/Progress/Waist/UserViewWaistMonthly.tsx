...
type UserViewWaistMonthlyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaistMonthly'
>
...
function UserViewWaistMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaistMonthlyNavigationProp>()
                ...
                <Box style={{ width: '100%' }} flexDirection="row" justifyContent="space-between">
                  ...
                  <Text variant="caption">
                    {(((dataset as WaistData[])[(dataset as WaistData[]).length - 1]
                      ['inches'] as number) > 0)
                      && goal?.goal && (`${((dataset as WaistData[])
...
export default UserViewWaistMonthly
