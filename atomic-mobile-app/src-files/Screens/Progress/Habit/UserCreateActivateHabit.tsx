...
type UserCreateActivateHabitNavigationProp = StackNavigationProp<
...
function UserCreateActivateHabit(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateHabitNavigationProp>()
  ...
  export default UserCreateActivateHabit
