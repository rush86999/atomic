...
type UserViewVegetableStatsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewVegetableStats'
>
...
function UserViewVegetableStats(props: Props) {
  ...
  const navigation = useNavigation<UserViewVegetableStatsNavigationProp>()
...
export default UserViewVegetableStats
