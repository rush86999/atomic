...
type UserViewVegetableWeeklyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewVegetableWeekly'
>
...
function UserViewVegetableWeekly(props: Props) {
  ...
  const navigation = useNavigation<UserViewVegetableWeeklyNavigationProp>()
...
export default UserViewVegetableWeekly
