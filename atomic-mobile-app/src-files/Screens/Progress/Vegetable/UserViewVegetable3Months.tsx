...
type UserViewVegetable3MonthsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewVegetable3Months'
>
...
function UserViewVegetable3Months(props: Props) {
  ...
  const navigation = useNavigation<UserViewVegetable3MonthsNavigationProp>()
  const { sub } = props
...
export default UserViewVegetable3Months
