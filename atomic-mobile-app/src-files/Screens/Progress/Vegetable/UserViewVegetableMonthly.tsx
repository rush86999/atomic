...
type UserViewVegetableMonthlyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewVegetableMonthly'
>
...
function UserViewVegetableMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewVegetableMonthlyNavigationProp>()
...
export default UserViewVegetableMonthly
