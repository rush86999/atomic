...
type RootStackParamList = {
  UserCreateActivateVegetable: {},
};

type UserCreateActivateVegetableNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserCreateActivateVegetable'
>
...
function UserCreateActivateVegetable(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateVegetableNavigationProp>()
  ...
  const createNewActiveComponent = async (): Promise<undefined | null> => {
    try {
      ...
      Toast.show({
            ...
            text2: `You have activated Vegetable Component 🙌`
         });
...
export default UserCreateActivateVegetable
