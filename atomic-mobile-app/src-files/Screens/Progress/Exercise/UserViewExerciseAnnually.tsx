...
type UserViewExerciseAnnuallyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewExerciseAnnually'
>
...
function UserViewExerciseAnnually(props: Props) {
  ...
  const navigation = useNavigation<UserViewExerciseAnnuallyNavigationProp>()
  ...
  }, [((dataset && dataset[(dataset as GenericExerciseData[]).length - 1] && dataset[(dataset as GenericExerciseData[]).length - 1].minutes) || 0), ((goal && goal?.goal))])
...
export default UserViewExerciseAnnually
