...
type UserViewExerciseWeeklyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewExerciseWeekly'
>
...
function UserViewExerciseWeekly(props: Props) {
  ...
  const navigation = useNavigation<UserViewExerciseWeeklyNavigationProp>()
...
export default UserViewExerciseWeekly
