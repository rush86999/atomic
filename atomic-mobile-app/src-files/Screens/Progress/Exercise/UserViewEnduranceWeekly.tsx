...
function UserViewEnduranceWeekly(props: Props) {
  ...
  const [selectedPickerItem, setSelectedPickerItem] = useState<pickerItem>('Reps')
...
export default UserViewEnduranceWeekly
