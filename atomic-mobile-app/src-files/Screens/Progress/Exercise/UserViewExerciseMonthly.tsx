...
type UserViewExerciseMonthlyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewExerciseMonthly'
>
...
function UserViewExerciseMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewExerciseMonthlyNavigationProp>()
...
export default UserViewExerciseMonthly
