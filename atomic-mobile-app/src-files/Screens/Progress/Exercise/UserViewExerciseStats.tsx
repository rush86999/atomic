...
type UserViewExerciseStatsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewExerciseStats'
>

function UserViewGenericExerciseStats(props: Props) {
  ...
  const navigation = useNavigation<UserViewExerciseStatsNavigationProp>()
...
export default UserViewGenericExerciseStats
