...
type UserViewFruitServing3MonthsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewFruitServing3Months'
>
...
function UserViewFruitServing3Months(props: Props) {
  ...
  const navigation = useNavigation<UserViewFruitServing3MonthsNavigationProp>()
...
export default UserViewFruitServing3Months
