...
type UserViewFruitServingStatsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewFruitServingStats'
>
...
function UserViewFruitServingStats(props: Props) {
  ...
  const navigation = useNavigation<UserViewFruitServingStatsNavigationProp>()
...
export default UserViewFruitServingStats
