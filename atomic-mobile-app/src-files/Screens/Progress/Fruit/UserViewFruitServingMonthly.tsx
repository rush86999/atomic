...
type RootStackParamList = {
  ...
  UserViewFruitServing: undefined,
}

type UserViewFruitServingNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewFruitServing'
>
...
function UserViewFruitServingMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewFruitServingNavigationProp>()
...
export default UserViewFruitServingMonthly
