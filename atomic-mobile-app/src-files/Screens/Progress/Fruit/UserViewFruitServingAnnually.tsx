...
type UserViewFruitServingAnnuallyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewFruitServingAnnually'
>
...
function UserViewFruitServingAnnually(props: Props) {
  ...
  const navigation = useNavigation<UserViewFruitServingAnnuallyNavigationProp>()
  const { sub } = props
...
export default UserViewFruitServingAnnually
