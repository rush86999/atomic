...
type RootNavigationStackParamList = {
  ...
  UserCreateActivateSteps: undefined,
}

type UserCreateActivateStepsNavigationProp = StackNavigationProp<
...
function UserCreateActivateSteps(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateStepsNavigationProp>()
  ...
  const createNewActiveComponent = async (): Promise<undefined | null> => {
    try {
      ...
      Toast.show({
            ...
            text2: `You have activated Step Component 🙌`
         });
...
export default UserCreateActivateSteps
