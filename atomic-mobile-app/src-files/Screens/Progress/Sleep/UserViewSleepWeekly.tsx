...
type UserViewSleepWeeklyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewSleepWeekly'
>
...
function UserViewSleepWeekly(props: Props) {
  ...
  const navigation = useNavigation<UserViewSleepWeeklyNavigationProp>()
...
export default UserViewSleepWeekly
