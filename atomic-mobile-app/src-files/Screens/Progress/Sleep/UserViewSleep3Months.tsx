...
type UserViewSleep3MonthsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewSleep3Months'
>
...
function UserViewSleep3Months(props: Props) {
  ...
  const navigation = useNavigation<UserViewSleep3MonthsNavigationProp>()
...
export default UserViewSleep3Months
