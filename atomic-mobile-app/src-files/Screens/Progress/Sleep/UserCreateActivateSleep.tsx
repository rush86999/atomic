...
UserCreateActivateSleep: {},
}

type UserCreateActivateSleepNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserCreateActivateSleep'
>
...
function UserCreateActivateSleep(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateSleepNavigationProp>()
  ...
  return (
    <Box flex={1} justifyContent="center" alignItems="center">
      <Wizard testID={'uilib.wizard'} activeIndex={activeIndex} onActiveIndexChanged={onActiveIndexChanged}>
        ...
        <Wizard.Step state={getStepState(2)} label={'Activate Sleep'}/>
      </Wizard>
      {renderCurrentStep()}
    </Box>
  )
...
export default UserCreateActivateSleep
