...
type UserViewSleepMonthlyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewSleepMonthly'
>
...
function UserViewSleepMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewSleepMonthlyNavigationProp>()
...
export default UserViewSleepMonthly
