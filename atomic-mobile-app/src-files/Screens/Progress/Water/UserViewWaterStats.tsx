...
type UserViewWaterStatsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaterStats'
>
...
function UserViewWaterStats(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaterStatsNavigationProp>()
...
export default UserViewWaterStats
