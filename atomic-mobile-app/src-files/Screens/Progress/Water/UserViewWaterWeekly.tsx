...
type UserViewWaterWeeklyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaterWeekly'
>
...
function UserViewWaterWeekly(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaterWeeklyNavigationProp>()
...
export default UserViewWaterWeekly
