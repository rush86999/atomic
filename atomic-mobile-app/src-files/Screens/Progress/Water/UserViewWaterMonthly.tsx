...
type UserViewWaterMonthlyNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWaterMonthly'
>
...
function UserViewWaterMonthly(props: Props) {
  ...
  const navigation = useNavigation<UserViewWaterMonthlyNavigationProp>()
...
export default UserViewWaterMonthly
