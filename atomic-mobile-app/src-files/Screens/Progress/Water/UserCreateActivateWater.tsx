...
type RootStackParamList = {
  UserCreateActivateWater: {},
}

type UserCreateActivateWaterNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserCreateActivateWater'
>
...
function UserCreateActivateWater(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateWaterNavigationProp>()
  ...
  const createNewActiveComponent = async (): Promise<undefined | null> => {
    try {
      ...
      Toast.show({
            ...
            text2: `You have activated Water Component 🙌`
         });
  ...
  return (
    <Box flex={1} justifyContent="center" alignItems="center">
      <Wizard testID={'uilib.wizard'} activeIndex={activeIndex} onActiveIndexChanged={onActiveIndexChanged}>
        ...
        <Wizard.Step state={getStepState(2)} label={'Activate Water'}/>
      </Wizard>
      {renderCurrentStep()}
    </Box>
  )
...
export default UserCreateActivateWater
