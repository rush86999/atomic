...
type UserViewWater3MonthsNavigationProp = StackNavigationProp<
  RootStackParamList,
  'UserViewWater3Months'
>
...
function UserViewWater3Months(props: Props) {
  ...
  const navigation = useNavigation<UserViewWater3MonthsNavigationProp>()
...
export default UserViewWater3Months
