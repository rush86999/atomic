...
function UserViewStrengthAnnually(props: Props) {
  ...
  //
  // const navigation = useNavigation<UserViewStrengthAnnuallyNavigationProp>()
...
export default UserViewStrengthAnnually
