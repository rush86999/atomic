...
type UserCreateActivateNewSkillNavigationProp = StackNavigationProp<
...
function UserCreateActivateNewSkill(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateNewSkillNavigationProp>()
  ...
  export default UserCreateActivateNewSkill
