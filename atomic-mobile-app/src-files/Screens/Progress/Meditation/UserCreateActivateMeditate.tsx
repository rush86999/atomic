...
type RootStackNavigationParamList = {
  ...
  UserCreateActivateMeditate: undefined,
}
...
type UserCreateActivateMeditateNavigationProp = StackNavigationProp<
...
function UserCreateActivateMeditate(props: Props) {
  ...
  const navigation = useNavigation<UserCreateActivateMeditateNavigationProp>()
  ...
  const createNewActiveComponent = async (): Promise<undefined | null> => {
    try {
      ...
      Toast.show({
            ...
            text2: `You have activated Meditate Component 🙌`
         });
...
export default UserCreateActivateMeditate
