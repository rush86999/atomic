...
function UserDefaultAlarms(props: Props) {
            ...
            <Box flex={1} justifyContent="center" alignItems="center">
                ...
                <Box flex={1} justifyContent="center" alignItems="center">
                    <Box m={{ phone: 'xs', tablet: 's' }}>
                        ...
                        <TextField
                            type="numeric"
                            onChangeText={(text: string) => setReminder(parseInt(text.replace(/[^0-9.]/g, ''), 10))}
                            value={`${reminder}`}
                            placeholder="0"
                            style={{ width: '40%' }}
                            title="Reminder"
                ...
                <Box flex={1} m={{ phone: 'xs', tablet: 's' }} justifyContent="center" alignItems="center">
                    <Button onPress={addItemToReminders}>
                        Add new reminder
                    </Button>
                </Box>
            </Box>
  ...
  export default UserDefaultAlarms