# Atomic Schedule Event Serverless

Atomic Schedule Event runs on aws lambda using serverless framework template. In other words, other cloud providers can be used with minimal code changes
