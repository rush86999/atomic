# Atomic Post Process Calendar Serverless

Atomic Post Process Calendar runs on aws lambda using serverless framework template. In other words, other cloud providers can be used with minimal code changes
