...
// SnapshotApi.prototype.list = function snapshotListApi(params, options, callback) {
//   [params, options, callback] = normalizeArguments(params, options, callback);
...
SnapshotApi.prototype.getRepositorySnapshots = function snapshotGetRepositorySnapshotsApi(params, options, callback) {
  [params, options, callback] = normalizeArguments(params, options, callback);
  ...
  let path = '';
  if (method == null) method = 'GET';
  path = '/' + '_snapshot' + '/' + encodeURIComponent(repository) + '/' + '_all';
...
Object.defineProperties(SnapshotApi.prototype, {
  ...
  get_repository_snapshots: {
    get() {
      return this.getRepositorySnapshots;
    },
  },
  repository_analyze: {
    get() {
